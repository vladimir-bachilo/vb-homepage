...
const Work = () => (
  <Layout title="Venue Planner">
    <Container>
      ...
      <Paragraph>
        Venue planner is the world’s first smart event planning software, that
        offers integrated safety and security planning in an intuitive, visually
        driven and auditable programme.
      </Paragraph>
